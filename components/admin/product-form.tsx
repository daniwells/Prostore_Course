...
const ProductForm = ({
    ...
    // Aqui fazemos com que `id` seja opcional
    type ProductFormSchema = InsertProduct & Partial<Pick<UpdateProduct, "id">>;

    const form = useForm<ProductFormSchema>({
    resolver: (type === "Update"
        ? zodResolver(updateProductSchema)
        : zodResolver(insertProductSchema)) as Resolver<ProductFormSchema>,
    defaultValues:
